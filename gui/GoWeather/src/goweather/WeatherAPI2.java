...
public class WeatherAPI2
{
	...
	public WeatherAPI2(String city)
	{
		theCity = city;
	...
	void parseWeather(String weatherHTML)
	{
		...
		while(startIndex != -1)
		{
			...
			{ // found a weather forecast
				...
				String conditions=getValueForKey(weatherForecast, "text");
                                String dayss=getValueForKey(weatherForecast, "day");
                                
				Forecast fore = new Forecast();
                                fore.days=dayss;
				fore.lowTemp = lowString;
				fore.highTemp = highString;
                                fore.conditionss = conditions;
